...
//
//    /**
//     * Sends a PING near echo time to exercise interleaving tolerance.
//     */
...
//                return;
//            }
//            // Kick a PING right before echo; frames may interleave on wire.
//            try {
...
//
//    /**
//     * Drops TCP abruptly without CLOSE.
//     */
...
//            // Abruptly drop the connection without close handshake after a short tick.
//            new Thread(() -> {
//                try {
//                    Thread.sleep(50);
