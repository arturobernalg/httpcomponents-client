...
public final class SimpleBufferPool {
    ...
    public SimpleBufferPool(final int bufferSize, final int maxCapacity) {
        this(bufferSize, maxCapacity, false);
    }

    public SimpleBufferPool(final int bufferSize, final int maxCapacity, final boolean direct) {
