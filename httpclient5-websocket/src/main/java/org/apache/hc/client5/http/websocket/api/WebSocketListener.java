...
public interface WebSocketListener {
    ...
    default void onBinary(final ByteBuffer payload, final boolean last) {
    }

    default void onPing(final ByteBuffer payload) {
    }

    default void onPong(final ByteBuffer payload) {
    }
