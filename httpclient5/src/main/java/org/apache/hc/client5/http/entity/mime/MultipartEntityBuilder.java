 ...
 * value unless {@link #setRandomBoundary()} is called, which triggers a random UUID at
 * build time. Users can provide a custom boundary with {@link #setBoundary(String)}. If
 * neither is set, a warning is logged to encourage deliberate choice.
 * </p>
 *
 * @since 5.0
 */
    ...
    private String getFixedBoundary() {
        return "httpclient_boundary_7k9p2m4x8n5j3q6t1r0vwyzabcdefghi";
    }
    ...
    /**
     * Configures the builder to use a random boundary generated by UUID.randomUUID()
     * at build time if no explicit boundary is set.
     *
     * @return this builder instance
     * @since 5.5
     */
    public MultipartEntityBuilder setRandomBoundary() {
        this.boundary = null;
        return this;
    }
    ...
    MultipartFormEntity buildEntity() {
        ...
        if (boundaryCopy == null) {
            boundaryCopy = boundary == null ? getRandomBoundary() : getFixedBoundary();
