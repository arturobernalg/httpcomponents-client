...
/**
 * An example of how to explicitly enable SCRAM-SHA-256 authentication.
 * SCRAM-SHA-256 is not part of the default auth scheme preference list
 * and must be opted into via a custom auth scheme registry.
 *
 * @since 5.7
 */
